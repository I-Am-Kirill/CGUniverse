    ...
    <div className="heaader-model-body">
      <div className='heaader-model-container-first'>
        <div className='heaader-model-box-title'>
          <h1 className='heaader-model-title'>Платформа для покупки<br></br> и продажи 3D и AR в <br></br>Интернете</h1>
        </div>
        <div className='heaader-model-box-text'>
          <p className='heaader-model-text'>Управляйте своими 3D-ресурсами. Распространяйте опыт 3D и AR. Сотрудничайте с другими. Продемонстрируйте свою работу.<br></br> Покупайте и продавайте 3D модели.</p>
        </div>
